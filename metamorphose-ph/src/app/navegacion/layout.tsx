...
const Layout = ({ children, }: Readonly <{ children: React.ReactNode }>) => {
  ...
  return (
    <div className="max-w-screen-xl max-h-screen-2xl font-afacad flex justify-center items-center  absolute top-52 left-32 right-32 rounded ">
      <nav className="h-10 border  border-black w-full flex flex-row align-center items-center tracking-widest justify-evenly text-xs fixed top-32 z-50 backdrop-blur-sm bg-gradient-to-t from-black to-zinc/20">
