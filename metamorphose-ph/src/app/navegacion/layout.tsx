...
const Layout = ({ children, }: Readonly <{ children: React.ReactNode }>) => {
  ...
  return (
    <div className="max-w-screen-xl max-h-full font-afacad flex justify-center absolute top-52 left-32 right-32 bg-gradient-to-b from-zinc-900 to-black-900 rounded">
      <nav className=" flex flex-row justify-evenly text-xs fixed top-40 left-32  right-32  z-50 backdrop-blur-lg ">
